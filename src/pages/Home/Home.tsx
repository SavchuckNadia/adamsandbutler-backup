...
const [newsList, setNewsList] = useState(Array<INewsPost>)
...
useEffect(() => {
getData("home_experience-carousel",setExperienceSlides,  setProgress, setLoading)
getData("home_news",setNewsList,  setProgress, setLoading)
